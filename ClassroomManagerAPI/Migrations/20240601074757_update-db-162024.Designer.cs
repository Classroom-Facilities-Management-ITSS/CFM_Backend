...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240601074757_update-db-162024")]
    partial class updatedb162024
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5225),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5227),
                            MaxSize = 0,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5225)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5230),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5231),
                            MaxSize = 0,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5230)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5135),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5135),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5168),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5168),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5172),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 6, 1, 14, 47, 56, 719, DateTimeKind.Local).AddTicks(5172),
                            Version = "Sony VPL 4K"
                        });
                });
