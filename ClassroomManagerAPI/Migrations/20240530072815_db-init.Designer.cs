...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240530072815_db-init")]
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9543),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9547),
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9543)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9628),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9631),
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9628)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9360),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9360),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9405),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9405),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9412),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 5, 30, 14, 28, 14, 705, DateTimeKind.Local).AddTicks(9412),
                            Version = "Sony VPL 4K"
                        });
                });
