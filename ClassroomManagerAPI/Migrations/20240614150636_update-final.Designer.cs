...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240614150636_update-final")]
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8463),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8465),
                            MaxSize = 0,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8463)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8468),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8469),
                            MaxSize = 0,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8468)
                        },
                        new
                        {
                            Id = new Guid("0540dec7-c15c-4d3d-9b24-a1cfca346209"),
                            Address = "Storage",
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8470),
                            FacilityAmount = 0,
                            IsDeleted = false,
                            LastUsed = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8472),
                            MaxSize = 0,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8470)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8315),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8315),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8347),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8347),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8351),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 6, 14, 22, 6, 36, 213, DateTimeKind.Local).AddTicks(8351),
                            Version = "Sony VPL 4K"
                        });
                });
