...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240517101609_renew-db")]
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2068),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2068)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2074),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2074)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(1981),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(1981),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2015),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2015),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2018),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 16, 8, 28, DateTimeKind.Local).AddTicks(2018),
                            Version = "Sony VPL 4K"
                        });
                });
