...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240517101955_update2")]
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(5005),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(5005)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(5009),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(5009)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4902),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4902),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4940),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4940),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4944),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 19, 54, 794, DateTimeKind.Local).AddTicks(4944),
                            Version = "Sony VPL 4K"
                        });
                });
