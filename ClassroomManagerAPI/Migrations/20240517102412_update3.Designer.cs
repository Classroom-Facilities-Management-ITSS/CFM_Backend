...
namespace ClassroomManagerAPI.Migrations
{
    ...
    [Migration("20240517102412_update3")]
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Classroom", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "D9-401",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7666),
                            FacilityAmount = 1,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7666)
                        },
                        new
                        {
                            Id = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Address = "D9-402",
                            CreatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7670),
                            FacilityAmount = 2,
                            IsDeleted = false,
                            Status = "OPEN",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7670)
                        });
                });
            ...
            modelBuilder.Entity("ClassroomManagerAPI.Entities.Facility", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7560),
                            IsDeleted = false,
                            Name = "Microphone",
                            Note = "on-built teacher provided Microphone for teaching purposes",
                            Status = "NEW",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7560),
                            Version = "1.7"
                        },
                        new
                        {
                            ...
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7597),
                            IsDeleted = false,
                            Name = "HDMI Cables",
                            Note = "HDMI Cables connected to projector",
                            Status = "OLD",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7597),
                            Version = "1.4"
                        },
                        new
                        {
                            ...
                            ClassroomId = new Guid("42d228cd-fa56-49ba-b429-f753e34a01f0"),
                            Count = 1,
                            CreatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7601),
                            IsDeleted = false,
                            Name = "Projector",
                            Note = "Projector connected to laptops via HDMI",
                            Status = "FIXING",
                            UpdatedAt = new DateTime(2024, 5, 17, 17, 24, 10, 960, DateTimeKind.Local).AddTicks(7601),
                            Version = "Sony VPL 4K"
                        });
                });
